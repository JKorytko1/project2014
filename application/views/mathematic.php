...
<br></br>
<p><img src="image/mat1.jpg" style="float:left"></p>
<center>
...
необходимых современному обществу.</p>
<br></br>
<p><b>Кафедра «Системы и процессы управления готовит специалистов высшей квалификации в различных областях создания новой техники, среди которых 
следует назвать:</b></p>

<p>- разработка высокоэффективных технологий программирования встроенных ЦВМ реального времени;</p>
<p>- создание различного электронного оборудования, начиная с вычислительных комплексов производительностью до миллиарда операций в секунду 
и кончая автомобильной электроникой и системой электронных платежей;</p>
<p>- разработка и производство современного электронного медицинского оборудования на основе компьютерных технологий;</p>
<p>- разработка и исследование систем регулирования паровых и газовых турбин;</p>
<p>- внедрение новых информационных технологий и разработка автоматизированных систем контроля и управления магистральными нефтегазопроводами; 
<p>- создание автоматических систем для управления подвижными объектами в космосе и на Земле.</p>
<br></br>
<p>Наших выпускников отличает широкая эрудиция и высокий профессионализм. Достаточно сказать, что многие из них связаны с созданием систем 
...
<p><img src="image/mat2.jpg" style="float:right"></p>
<br></br>

<p><b>Обучение на нашей специальности обеспечивает:</b></p>

<p>- получение квалификации «инженер-математик-исследователь»;
<p>- широту и универсальность теоретической и практической подготовки, позволяющую одинаково успешно работать в самых различных областях 
научной и инженерной деятельности;</p>
<p>- глубокие знания фундаментальных и специальных дисциплин и умение применять полученные знания на практике;</p>
<p>- высокую восприимчивость к новым знаниям и владение навыками самостоятельной научно-исследовательской работы;</p>
<p>- высокую компетентность в области использования современной вычислительной техники, овладение современными информационными и 
компьютерными технологиями.</p>
<p>- трудоустройство по специальности на ведущих предприятиях г. Харькова: «Хартрон», «Коммунар», «Турбоатом».</p>
<p>Основные преимущества нашей специальности, выделяющие ее сегодня среди других, состоят в удачном сочетании сложившейся за долгие годы 
...
<div class="container">
    <div class="row">
        <div class="col-md-10 col-md-offset-2">
            <h1 align="center" class="blog-post-title" style="color:Red;">Прикладная математика</h1>

          <br></br>
            
                               <img src="<?=base_url();?>assets/images/mat1.jpg" style="float:left; margin-right: 15px;">
                
				<p align="justify"><big>Математическое моделирование сложных систем и процессов, анализ и синтез систем управления, эксплуатация ЭВМ, сетей ЭВМ, 
				прикладное и системное программирование, теория информации и ее приложения – это магистральные направления в подготовке специалистов, 
				необходимых современному обществу.</p><br>
				<p align="justify"><b>Кафедра «Системы и процессы управления готовит специалистов высшей квалификации в различных областях создания новой техники, среди которых 
				следует назвать:</b></p>

				<p align="justify">- разработка высокоэффективных технологий программирования встроенных ЦВМ реального времени;</p>
				<p align="justify">- создание различного электронного оборудования, начиная с вычислительных комплексов производительностью до миллиарда операций в секунду 
				и кончая автомобильной электроникой и системой электронных платежей;</p>
				<p align="justify">- разработка и производство современного электронного медицинского оборудования на основе компьютерных технологий;</p>
				<p align="justify">- разработка и исследование систем регулирования паровых и газовых турбин;</p>
				<p align="justify">- внедрение новых информационных технологий и разработка автоматизированных систем контроля и управления магистральными нефтегазопроводами; 
				<p align="justify">- создание автоматических систем для управления подвижными объектами в космосе и на Земле.</p>
				<br>
				...
				Уровень подготовки специалистов, выпускаемых нашей кафедрой, соответствует самым высоким мировым требованиям.</p>
				<br></br>
				<img src="<?=base_url();?>assets/images/mat2.jpg" style="float:right; margin-left: 15px;">
				

				<p align="justify"><b>Обучение на нашей специальности обеспечивает:</b></p>

				<p align="justify">- получение квалификации «инженер-математик-исследователь»;
				<p align="justify">- широту и универсальность теоретической и практической подготовки, позволяющую одинаково успешно работать в самых различных областях 
				научной и инженерной деятельности;</p>
				<p align="justify">- глубокие знания фундаментальных и специальных дисциплин и умение применять полученные знания на практике;</p>
				<p align="justify">- высокую восприимчивость к новым знаниям и владение навыками самостоятельной научно-исследовательской работы;</p>
				<p align="justify">- высокую компетентность в области использования современной вычислительной техники, овладение современными информационными и 
				компьютерными технологиями.</p>
				<p align="justify">- трудоустройство по специальности на ведущих предприятиях г. Харькова: «Хартрон», «Коммунар», «Турбоатом».</p>
				<p align="justify">Основные преимущества нашей специальности, выделяющие ее сегодня среди других, состоят в удачном сочетании сложившейся за долгие годы 
				системы подготовки специалистов, преподавательских кадров высшей квалификации, четкой направленности на решение важнейших задач современного
				 производства с многообразием возможных направлений приложения полученных знаний и навыков.</big></p>
