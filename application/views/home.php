 <?php include_once('block/header.php');?>
    ...
    <div class="container" id="news">
    	<div class="row">
			...
			<h2>Изменения графика учебного процесса</h2>
		    <p>Октябрь 21, 2014 by <a href="<?=base_url();?>index.php/news.php">Admin</a></p>
		    <p align="justify">В 2014–2015 учебный год внесены некоторые изменения отдельных элементов графика учебного процесса. Однако эти изменения не коснутся количества отведенного для учебы времени и не повлияют на качество учебного процесса. 
			То есть, количество часов останется прежним: 16 недель лекционных и практических занятий с понедельника по пятницу. Суббота останется выходным днем.<a href="news.php" target="_blank"> Читать далее</a></p>
	       	<br></br>
	        <h2>Товажнянский продолжает свою работу в должности ректора</h2>
		    <p>Октябрь 21, 2014 by <a href="<?=base_url();?>index.php/news.php">Admin</a></p>
